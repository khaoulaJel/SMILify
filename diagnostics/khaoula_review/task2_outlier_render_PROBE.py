"""TASK 2 Hard Rule item 4: visual renders for the outlier specimens flagged by
task2_hardrule_reanalysis_PROBE.py (largest |delta gaster-legs count| and
|delta fscore@0.01| between fit3d_results_all_offset_baseline and fit3d_results_all_offset_gentle).
...
FLAGGED = [
    "Lasius_nr._fuliginosus_CASENT0878037_processed.obj",
...
RUNS = ["fit3d_results_all_offset_baseline", "fit3d_results_all_offset_gentle"]
...
def main():
    ...
    for view, (a, b), vname in [((0, 2), (0, 2), "lateral_XZ"), ((1, 2), (1, 2), "anterior_YZ")]:
        ...
        plt.tight_layout()
        p = os.path.join(REPO, OUT, f"task2_outliers_{vname}.png")
